...
public class DriveTrainSubSystem extends SubsystemBase {
  ...
  TalonSRX leftTalon = new TalonSRX(Constants.leftTalon);
  TalonSRX rightTalon = new TalonSRX(Constants.rightTalon);
  VictorSPX leftVictor = new VictorSPX(Constants.leftVictor);
